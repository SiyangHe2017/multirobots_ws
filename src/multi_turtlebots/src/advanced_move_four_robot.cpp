...
// float do_y_position[DYNAMIC_OBSTACLE_NUMBER];
// float do_theta[DYNAMIC_OBSTACLE_NUMBER];
// float do_linear_velocity[DYNAMIC_OBSTACLE_NUMBER];
// float do_angular_velocity[DYNAMIC_OBSTACLE_NUMBER];
...
void setupScenario(RVO::RVOSimulator *sim)
{
  ...
  obstacle1.push_back(RVO::Vector2(-0.85f, 1.15f));
  obstacle1.push_back(RVO::Vector2(-1.15f, 1.15f));
  obstacle1.push_back(RVO::Vector2(-1.15f, 0.85f));
  obstacle1.push_back(RVO::Vector2(-0.85f, 0.85f));

  obstacle2.push_back(RVO::Vector2(0.85f, 1.15f));
  obstacle2.push_back(RVO::Vector2(0.85f, 0.85f));
  obstacle2.push_back(RVO::Vector2(1.15f, 0.85f));
  obstacle2.push_back(RVO::Vector2(1.15f, 1.15f));

  obstacle3.push_back(RVO::Vector2(0.85f, -1.15f));
  obstacle3.push_back(RVO::Vector2(1.15f, -1.15f));
  obstacle3.push_back(RVO::Vector2(1.15f, -0.85f));
  obstacle3.push_back(RVO::Vector2(0.85f, -0.85f));

  obstacle4.push_back(RVO::Vector2(-0.85f, -1.15f));
  obstacle4.push_back(RVO::Vector2(-0.85f, -0.85f));
  obstacle4.push_back(RVO::Vector2(-1.15f, -0.85f));
  obstacle4.push_back(RVO::Vector2(-1.15f, -1.15f));
...
void setVelocityToTurtlebot3(RVO::RVOSimulator *sim)
{
  for (std::size_t i = 0; i < sim->getNumAgents(); ++i)
  {
    ...
    {
      if (temp_orientation > temp_velocity_tan)
      { // clockwise
...
void updateTurtlebot3Status(RVO::RVOSimulator *sim, ros::Publisher tb3_pub[])
{
  ...
  {
    if (tb3_reached[i])
    { // make the robot still if it reaches goal
      linear.x = 0.0f;
      angular.z = 0.0f;
    }
    else
